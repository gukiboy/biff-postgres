(ns com.kishima.app
  (:require [com.biffweb :as biff :refer [q]]
            [com.kishima.middleware :as mid]
            [com.kishima.ui :as ui]
            [com.kishima.settings :as settings]
            [rum.core :as rum]
            [xtdb.api :as xt]
...
(defn notify-clients [{:keys [com.kishima/chat-clients]} tx]
...
(defn ws-handler [{:keys [com.kishima/chat-clients] :as ctx}]
  {:status 101
